...
const Home : FC<bookType> = ({ navigation }) => {
    ...
    function renderHeader(profile: { name: any; point: any; }) {
        return (
    ...
    function renderMyBookSection(myBooks: ArrayLike<any> | null | undefined) {
        ...
        const renderItem : FC<renderType> = ({ item, index }) => {
            return (
                <TouchableOpacity
                    style={{
                        flex: 1,
    ...
    function renderCategoryHeader() {
        ...
        const renderItem : FC<renderType> = ({ item }) => {
            return (
                <TouchableOpacity
